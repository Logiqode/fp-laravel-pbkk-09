        ...
        <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
          <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            ...
            <div class="mt-6 sm:mt-8 lg:mt-0">
              <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">{{ $listing->name }}</h1>
              <div class="mt-4 sm:items-center sm:gap-4 sm:flex">
                <p class="text-2xl font-extrabold text-gray-900 sm:text-3xl dark:text-white">${{ $listing->price }}</p>
                <p>bought 972 times</p>
              </div>
              ...
              <p class="mb-6 text-gray-500 dark:text-gray-400">{{ $listing->description }}</p>
            </div>
          </div>
        </div>
      </section>
