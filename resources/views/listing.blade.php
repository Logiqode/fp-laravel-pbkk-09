    ...
    @if(session()->has('cartAddSuccess'))
            ...
            <section class="py-8 antialiased">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                    ...
                    <div class="pt-2">{{ $listing->status }}</div>
                    ...
                    <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                        ...
                        <form action="/cart/{{ $listing->id }}/add" method="POST" class="inline">
                            @csrf
                            <button type="submit" class="inline-flex items-center rounded-lg px-5 py-2.5 text-sm font-medium text-white focus:outline-none focus:ring-4 dark:focus:ring-primary-800 {{ $listing->status == 'Out of Stock' ? 'bg-gray-400 cursor-not-allowed' : 'bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700' }}" {{ $listing->status == 'Out of Stock' ? 'disabled' : '' }}>
