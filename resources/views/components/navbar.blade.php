            ...
            <div class="flex items-center">
                ...
                @auth
                    <div class="ml-4 flex items-center space-x-4 hidden md:flex">
                        ...
                        <!-- Store Icon -->
                        <x-nav-link href="/store" :active="request()->is('store') || request()->is('store/storeListing') || request()->is('store/add')">
                ...
                @else
                    <div class="hidden md:flex flex">
                        <x-nav-link href="/login" :active="request()->is('login') || request()->is('register') || request()->is('login/forgot-password')">Login</x-nav-link>
                    </div>
                @endauth
